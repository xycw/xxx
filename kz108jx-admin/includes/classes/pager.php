...
class pager {
    ...
    {
    	return href_link(basename($_SERVER['PHP_SELF']), get_all_get_params(array('page', 'limit')) . 'limit=' . $limit);
    }
    
    public function getPageUrl($page)
    {
    	return href_link(basename($_SERVER['PHP_SELF']), get_all_get_params(array('page')) . 'page=' . $page);
    }
