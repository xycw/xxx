		...
		<form id="form-validate" method="post" action="<?php echo href_link(FILENAME_ADDRESS_EDIT, '', 'SSL'); ?>">
			...
			<div class="row">
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control input-text required-entry" minlength="2" value="<?php echo $address['firstname']; ?>" name="address[firstname]" id="address-firstname" />
				</div>
				<div class="form-group col-md-6">
					<label class="required" for="address-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
					<input type="text" class="form-control input-text required-entry" minlength="2" value="<?php echo $address['lastname']; ?>" name="address[lastname]" id="address-lastname" />
				</div>
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-12">
					...
					<input type="text" class="form-control input-text required-entry" minlength="10" value="<?php echo $address['street_address']; ?>" name="address[street_address]" id="address-street_address" />
				</div>
				<div class="form-group col-md-12">
				...
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control input-text required-entry" minlength="2" value="<?php echo $address['city']; ?>" name="address[city]" id="address-city" />
				</div>
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control input-text required-entry" minlength="2" value="<?php echo $address['postcode']; ?>" name="address[postcode]" id="address-postcode" />
				</div>
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control input-text required-entry" minlength="2" value="<?php echo $address['telephone']; ?>" name="address[telephone]" id="address-telephone" />
				</div>
				<div class="form-group col-md-6">
