...
require(DIR_FS_CATALOG_MODULES . 'meta.php'); ?>
<!DOCTYPE html>
...
<?php // 加载当前模板css文件夹中所有名称为style*.css的样式文件 ?>
	<link rel="stylesheet" type="text/css" href="xxx/js/jquery/bootstrap-3.3.7/css/bootstrap.min.css" />
	<link rel="stylesheet" type="text/css" href="//at.alicdn.com/t/font_375202_rffro0w6xuutmx6r.css" />
<?php $directory_css = 'xxx'.$template->get_template_dir('.css', DIR_WS_TEMPLATE, $current_page, 'css'); ?>
...
<?php } ?>
	<script type="text/javascript" src="xxx/js/jquery/jquery.js"></script>
    <script type="text/javascript" src="xxx/js/jquery/base.js"></script>
	<script type="text/javascript" src="xxx/js/jquery/validate.js"></script>
<?php if (STORE_LANGUAGE!='en') { ?>
    <script type="text/javascript" src="xxx/js/jquery/validate/messages_<?php echo STORE_LANGUAGE; ?>.js"></script>
<?php } ?>
	<script type="text/javascript" src="xxx/js/jquery/tabs.js"></script>
