...
<div class="box-collateral box-review" id="customer-review">
	...
	<dl>
		<dt>
			...
			<?php echo __('By <span>%s</span>', $val['nickname']); ?><br />
			<?php echo date_short($val['date_added']); ?>
		</dt>
		<dd><div class="f-fix"><?php echo $val['content']; ?></div></dd>
	</dl>
	<?php } ?>
	<?php require($template->get_template_dir('tpl_modules_pager.php', DIR_WS_TEMPLATE, $current_page, 'templates') . 'tpl_modules_pager.php'); ?>
	...
	<div class="form-add">
		...
		<ul class="form-list">
			...
			<li>
				...
				<div class="input-box">
					<input type="text" value="<?php echo isset($_SESSION['customer_firstname'])?$_SESSION['customer_firstname']:'';?>" class="input-text required-entry" id="review-nickname" name="review[nickname]">
				</div>
			</li>
			<li>
				<label class="required" for="review-content"><em>*</em><?php echo __('Review'); ?></label>
				<div class="input-box">
					<textarea class="required-entry" rows="3" cols="5" id="review-content" name="review[content]"></textarea>
				</div>
			</li>
		</ul>
