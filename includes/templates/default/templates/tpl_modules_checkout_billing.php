        ...
        <ul>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" minlength="2" value="<?php echo isset($billing['firstname'])?$billing['firstname']:''; ?>" name="billing[firstname]" id="billing-firstname" />
					</div>
				</div>
				<div class="field">
					<label class="required" for="billing-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
					<div class="input-box">
						<input type="text" class="input-text required-entry" minlength="2" value="<?php echo isset($billing['lastname'])?$billing['lastname']:''; ?>" name="billing[lastname]" id="billing-lastname" />
					</div>
				</div>
			</li>
			<li class="fields">
				...
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry validate-email" minlength="10" value="<?php echo isset($billing['email_address'])?$billing['email_address']:''; ?>" name="billing[email_address]" id="billing-email_address" />
					</div>
				</div>
				<?php } ?>
			</li>
			<li class="wide">
				...
				<div class="input-box">
					<input type="text" class="input-text required-entry" minlength="10" value="<?php echo isset($billing['street_address'])?$billing['street_address']:''; ?>" name="billing[street_address]" id="billing-street_address" />
				</div>
			</li>
			<li class="wide">
				<div class="input-box">
				...
				<li class="fields">
					<div class="field">
						<label class="required" for="billing-city"><em>*</em><?php echo __('City'); ?></label>
	 					<div class="input-box">
							<input type="text" class="input-text required-entry" minlength="2" value="<?php echo isset($billing['city'])?$billing['city']:''; ?>" name="billing[city]" id="billing-city" />
					</div>
				</div>
				<div class="field">
			...
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" minlength="2" value="<?php echo isset($billing['postcode'])?$billing['postcode']:''; ?>" name="billing[postcode]" id="billing-postcode" />
					</div>
				</div>
				<div class="field">
			...
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" minlength="2" value="<?php echo isset($billing['telephone'])?$billing['telephone']:''; ?>" name="billing[telephone]" id="billing-telephone" />
					</div>
				</div>
				<div class="field">
