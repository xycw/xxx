...
<div class="review-list">
	...
	<ol id="review-items">
		...
		<li>
			<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_review['product_id']); ?>" title="<?php echo $_review['nameAlt']; ?>" class="product-image"><img width="<?php echo REVIEW_IMAGE_WIDTH; ?>" height="<?php echo REVIEW_IMAGE_HEIGHT; ?>" alt="<?php echo $_review['nameAlt']; ?>" src="<?php echo get_small_image($_review['image'], REVIEW_IMAGE_WIDTH, REVIEW_IMAGE_HEIGHT); ?>" /></a>
