...
<div class="box-collateral box-related">
	...
	<?php $column_count = RELATED_PER_ROW; ?>
	<?php $i=0; ?>
    ...
    <?php } ?>
    	<li class="item">
    		<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image"><img width="<?php echo RELATED_IMAGE_WIDTH; ?>" height="<?php echo RELATED_IMAGE_HEIGHT; ?>" alt="<?php echo $_product['nameAlt']; ?>" src="<?php echo get_small_image($_product['image'], RELATED_IMAGE_WIDTH, RELATED_IMAGE_HEIGHT); ?>" /></a>
    ...
    <?php if ($i%$column_count==0 || $i==$relatedListCount) { ?>
    </ul>
    <?php } ?>
    <?php } ?>
    <script type="text/javascript">decorateList($('ul.products-related'));</script>
</div>
<?php } ?>
