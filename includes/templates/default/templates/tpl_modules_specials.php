...
<div class="specials">
	...
	<?php $column_count = SPECIALS_PER_ROW; ?>
	<?php $i=0; ?>
    ...
    <?php if ($i%$column_count==0 || $i==$specialsListCount) { ?>
    </ul>
    <?php } ?>
    <?php } ?>
    <script type="text/javascript">decorateList($('.specials ul.products-grid'));</script>
</div>
<?php } ?>
