...
<div class="ordered-products">
	...
	<?php $column_count = ORDERED_PRODUCTS_PER_ROW; ?>
	<?php $i=0; ?>
    ...
    <?php if ($i%$column_count==0 || $i==$orderedProductsListCount) { ?>
    </ul>
    <?php } ?>
    <?php } ?>
    <script type="text/javascript">decorateList($('.ordered-products ul.products-grid'));</script>
</div>
<?php } ?>
