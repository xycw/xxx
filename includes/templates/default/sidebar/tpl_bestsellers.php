<?php include(DIR_FS_CATALOG_MODULES . get_module_directory('sidebar/bestsellers.php')); ?>
<?php if (count($bestsellersSidebarList)>0) { ?>
<div class="block block-bestsellers">
	<div class="block-title">
        <strong><span><?php echo __('Bestsellers'); ?></span></strong>
    </div>
    <div class="block-content">
    	<ol id="bestsellers-items" class="mini-products-list">
    		<?php foreach ($bestsellersSidebarList as $_product) { ?>
    		<li class="item">
    			<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image"><img width="<?php echo BESTSELLERS_SIDEBAR_IMAGE_WIDTH; ?>" height="<?php echo BESTSELLERS_SIDEBAR_IMAGE_HEIGHT; ?>" alt="<?php echo $_product['nameAlt']; ?>" src="<?php echo get_small_image($_product['image'], BESTSELLERS_SIDEBAR_IMAGE_WIDTH, BESTSELLERS_SIDEBAR_IMAGE_HEIGHT); ?>" /></a>
