            ...
            <ul class="form-list">
                <li class="fields">
                    <div class="field">
                        ...
                        <div class="input-box">
                            <input type="text" class="form-control required-entry" minlength="2" value="<?php echo isset($customer['firstname'])?$customer['firstname']:''; ?>" name="customer[firstname]" id="customer-firstname" />
                        </div>
                    </div>
                </li>
                <li class="fields">
                    <div class="field">
                        ...
                        <div class="input-box">
                            <input type="text" class="form-control required-entry" minlength="2" value="<?php echo isset($customer['lastname'])?$customer['lastname']:''; ?>" name="customer[lastname]" id="customer-lastname" />
                        </div>
                    </div>
                </li>
                <li class="fields">
                    <div class="field">
                        ...
                        <div class="input-box">
                            <input type="text" class="form-control required-entry validate-email" minlength="10" value="<?php echo isset($customer['email_address'])?$customer['email_address']:''; ?>" name="customer[email_address]" id="customer-email_address" />
                        </div>
                    </div>
                </li>
                <li class="fields">
