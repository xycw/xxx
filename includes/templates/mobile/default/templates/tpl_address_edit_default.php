			...
			<ul class="form-list">
				<li class="fields">
					<div class="field">
						...
						<div class="input-box">
							<input type="text" class="form-control required-entry" minlength="2" value="<?php echo $address['firstname']; ?>" name="address[firstname]" id="address-firstname" />
						</div>
					</div>
					<div class="field">
						<label class="required" for="address-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
						<div class="input-box">
							<input type="text" class="form-control required-entry" minlength="2" value="<?php echo $address['lastname']; ?>" name="address[lastname]" id="address-lastname" />
						</div>
					</div>
				</li>
				<li class="fields">
				...
				<li class="wide">
					...
					<div class="input-box">
						<input type="text" class="form-control required-entry" minlength="10" value="<?php echo $address['street_address']; ?>" name="address[street_address]" id="address-street_address" />
					</div>
				</li>
				<li class="wide">
					<div class="input-box">
				...
				<li class="fields">
					<div class="field">
						...
						<div class="input-box">
							<input type="text" class="form-control required-entry" minlength="2" value="<?php echo $address['city']; ?>" name="address[city]" id="address-city" />
						</div>
					</div>
					<div class="field">
				...
				<li class="fields">
					<div class="field">
						...
						<div class="input-box">
							<input type="text" class="form-control required-entry" minlength="2" value="<?php echo $address['postcode']; ?>" name="address[postcode]" id="address-postcode" />
						</div>
					</div>
					<div class="field">
				...
				<li class="fields">
					<div class="field">
						...
						<div class="input-box">
							<input type="text" class="form-control required-entry" minlength="2" value="<?php echo $address['telephone']; ?>" name="address[telephone]" id="address-telephone" />
						</div>
					</div>
					<div class="field">
