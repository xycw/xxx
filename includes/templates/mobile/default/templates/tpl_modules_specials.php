...
<div class="index-products-grid specials">
	<div class="page-title">
        <a href="<?php echo href_link(FILENAME_SPECIALS); ?>"><h2 class="subtitle"><?php echo __('Specials'); ?></h2></a>
	</div>
    ...
    <div class="view-all"><a href="<?php echo href_link(FILENAME_SPECIALS); ?>" class="btn btn-default btn-block"><i class="iconfont f-13">&#xe69d;</i>View All</a></div>
</div>
<?php } ?>
