...
<div class="index-products-grid new-products">
	<div class="page-title">
        <a href="<?php echo href_link(FILENAME_NEW_PRODUCTS); ?>"><h2 class="subtitle"><?php echo __('New Arrivals'); ?></h2></a>
	</div>
    ...
    <div class="view-all"><a href="<?php echo href_link(FILENAME_NEW_PRODUCTS); ?>" class="btn btn-default btn-block"><i class="iconfont f-13">&#xe69d;</i>View All</a></div>
</div>
<?php } ?>
