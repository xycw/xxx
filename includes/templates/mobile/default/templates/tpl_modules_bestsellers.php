...
<div class="bestsellers">
	<div class="page-title">
        <a href="<?php echo href_link(FILENAME_BESTSELLERS); ?>"><h2 class="subtitle"><?php echo __('Bestsellers'); ?></h2></a>
	</div>
    ...
    <div class="view-all"><a href="<?php echo href_link(FILENAME_BESTSELLERS); ?>" class="btn btn-default btn-block"><i class="iconfont f-13">&#xe69d;</i>View All</a></div>
</div>
<?php } ?>
