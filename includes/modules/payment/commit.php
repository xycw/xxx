...
class commit
{
	function process($payment)
	{
		...
		$payment_form .= '<input type="hidden" value="' . $v_Version . '" name="Version">' . "\n";
		...
		if ($payment->get_is_inside()==1) {
			$payment_form .= '<iframe width="100%" height="650" scrolling="no" style="border:none;margin:0 auto;overflow:hidden;" id="ifrm_checkout" name="ifrm_checkout"></iframe>' . "\n";
